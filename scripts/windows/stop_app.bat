...
set "ASYNC_LOG=%LOG_DIR%\stop_app.%RUN_TOKEN%.async.log"
type nul > "%ASYNC_LOG%"

echo ======================================
echo   AI for Investor - 后台停止中
echo ======================================
echo.
echo [INFO] 已提交到后台执行
