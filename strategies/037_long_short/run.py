...
# -*- coding: utf-8 -*-
"""
Run script for Long Short Strategy

This script runs the Long Short Strategy backtest with configuration
...
from strategy_long_short import load_config, LongShortStrategy
