#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Run script for MACD Gradient Strategy.

This script runs a backtest for the MACD Gradient strategy and validates
...
from strategy_macd_gradient import MACDGradientStrategy, load_config
...
def run():
    """Run the MACD Gradient strategy backtest.
    ...
    cerebro.addstrategy(MACDGradientStrategy, **params)
