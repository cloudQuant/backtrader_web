...
# -*- coding: utf-8 -*-
"""
Run script for Pinkfish Challenge Strategy.

This script runs the Pinkfish Challenge Strategy backtest with data loading
...
from strategy_pinkfish import load_config, PinkfishStrategy
...
if __name__ == "__main__":
    print("=" * 60)
    print("Pinkfish Challenge Strategy Backtest")
    print("=" * 60)
    run()
