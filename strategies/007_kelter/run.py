#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Keltner Channel Multi-Contract Futures Strategy Runner.
...
from strategy_kelter import KeltnerStrategy, RbPandasFeed
...
def run():
    """Run the Keltner Channel multi-contract futures strategy backtest.
