#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Run script for Simple RSI Strategy.

This script runs a backtest for the Simple RSI strategy and validates
...
from strategy_simple_rsi import SimpleRSIStrategy, load_config
...
def run():
    """Run the Simple RSI strategy backtest.
    ...
    cerebro.addstrategy(SimpleRSIStrategy, **params)
