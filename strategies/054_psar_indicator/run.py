#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""PSAR Parabolic SAR Indicator Strategy Runner.

This module runs the PSAR Parabolic SAR strategy backtest.
"""
...
def run():
    """Run the PSAR Parabolic SAR strategy backtest.
    ...
    assert abs(sharpe_ratio - (2.423395072162198)) < 1e-6, f"Expected sharpe_ratio=2.423395072162198, got {sharpe_ratio}"
    assert abs(annual_return - (0.026394826422567123)) < 1e-6, f"Expected annual_return=0.026394826422567123, got {annual_return}"
    assert abs(max_drawdown - 3.0649081759956647) < 1e-6, f"Expected max_drawdown=3.0649081759956647, got {max_drawdown}"
...
if __name__ == "__main__":
    print("=" * 60)
    print("PSAR Parabolic SAR Indicator Strategy")
    print("=" * 60)
    run()
