#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Run script for ATR Momentum Strategy.

This script runs the ATR Momentum strategy which combines RSI, SMA200,
and ATR for momentum trading with volatility-based risk management.
"""
...
def load_data(symbol: str):
    """Load ORCL stock data for the strategy.

    Args:
        symbol: Stock symbol (e.g., "ORCL")

    Returns:
        Backtrader data feed with date range filter (2005-2010)
    """
...
def run():
    """Run the ATR Momentum strategy backtest.
...
if __name__ == "__main__":
    ...
    from strategy_atr_momentum import ATRMomentumStrategy

    print("=" * 60)
    print("ATR Momentum Strategy")
    print("=" * 60)
    run()
