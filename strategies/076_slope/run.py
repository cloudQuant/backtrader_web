#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Run script for Slope Strategy.

This script runs a backtest for the Slope strategy and validates
...
from strategy_slope import SlopeStrategy, load_config
...
def run():
    """Run the Slope strategy backtest.
    ...
    cerebro.addstrategy(SlopeStrategy, **params)
