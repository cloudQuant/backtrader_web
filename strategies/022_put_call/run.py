#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Put/CallPut/Call Ratio SentimentStrategyBacktestRunscript
...
def run():
    ...
    # AddStrategyand default parameters
    cerebro.addstrategy(
    ...
    # verify resultsandmatch expected values
