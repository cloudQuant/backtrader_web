#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Treasury Bond Futuresinter-month arbitrageStrategyBacktestRunscript
...
from strategy_arbitrage import TreasuryFuturesSpreadArbitrageStrategy
...
def run():
    ...
    cerebro.addstrategy(
        ...
        spread_low=params['spread_low'],
        spread_high=params['spread_high']
    )
