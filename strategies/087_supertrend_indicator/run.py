#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Strategy Runner - SuperTrendIndicatorStrategy"""
...
from strategy_supertrend_indicator import (
    SuperTrendIndicatorStrategy,
    SuperTrendIndicator
)
...
def run():
    ...
    cerebro.addstrategy(SuperTrendIndicatorStrategy, **params)
