#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Sharpe Ratio and TimeReturn Analyzer Strategy Runner.

This module runs the Sharpe ratio and TimeReturn analyzer strategy backtest.
"""
...
def run():
    """Run the Sharpe ratio and TimeReturn analyzer strategy backtest.
...
if __name__ == "__main__":
    print("=" * 60)
    print("Sharpe TimeReturn Strategy")
    print("=" * 60)
    run()
