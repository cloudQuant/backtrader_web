...
def run():
    ...
    cerebro.addstrategy(UdvdStrategy, **params)
    ...
    assert abs(final_value - 99939.44) < 0.01, f"Expected final_value=99939.44, got {final_value}"
    ...
    assert abs(max_drawdown - 0.20019346669376056) < 1e-6, f"Expected max_drawdown=0.20019346669376056, got {max_drawdown}"
