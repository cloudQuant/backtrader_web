#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Run script for Extended Cross Strategy.

This script runs a backtest for the Extended Cross strategy and validates
...
from strategy_extended_cross import ExtendedCrossStrategy, load_config
...
def run():
    """Run the Extended Cross strategy backtest.
    ...
    cerebro.addstrategy(ExtendedCrossStrategy, **params)
