#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Run script for Bollinger Bands Mean Reversion Strategy.

This script runs a backtest of the Bollinger Bands mean reversion strategy.
"""
...
def run():
    """Run the Bollinger Bands mean reversion strategy backtest.

    This function:
    1. Loads configuration from config.yaml
    2. Loads Oracle stock data from 2010-2014
    3. Runs the Bollinger Bands mean reversion strategy
