#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Strategy Runner - MACD+RSI+Bollinger BandsMultiIndicatorStrategy"""
...
def run():
    ...
    cerebro.addstrategy(MacdRsiBbStrategy, **params)
    ...
    print(f"Data loaded: {datetime.datetime(2010, 1, 1)} to {datetime.datetime(2014, 12, 31)}")
