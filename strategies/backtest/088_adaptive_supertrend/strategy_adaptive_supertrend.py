...
Adaptive SuperTrend strategy - trend-following system with dynamically
adjusted multiplier based on ATR.
"""
...
def create_strategy_from_config():
    ...
    Returns:
        AdaptiveSuperTrendStrategy: Configured strategy class
    """
    config = load_config()
