#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Fear and Greed IndexStrategyBacktestRunscript
...
from strategy_fear_greed import FearGreedStrategy, SPYFearGreedData
...
def run():
    ...
    cerebro.addstrategy(
        ...
        FearGreedStrategy,
        fear_threshold=params['fear_threshold'],
