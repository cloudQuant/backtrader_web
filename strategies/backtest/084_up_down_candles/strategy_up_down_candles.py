...
Up Down Candle Mean Reversion Strategy - identifies overbought and oversold
opportunities based on candle strength and price return rates.
"""
...
def create_strategy_from_config():
    ...
    Returns:
        UpDownCandlesStrategy: Configured strategy instance
    """
    config = load_config()
