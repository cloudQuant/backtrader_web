#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Strategy Runner - MACD+DMISimplifyStrategy"""
...
def run():
    ...
    cerebro.addstrategy(MacdDmiSimpleStrategy, **params)
    ...
    assert abs(final_value - 99948.71) < 0.01, f"Expected final_value=99948.71, got {final_value}"
    ...
    assert abs(max_drawdown - 0.12263737758169839) < 1e-6, f"Expected max_drawdown=0.12263737758169839, got {max_drawdown}"
