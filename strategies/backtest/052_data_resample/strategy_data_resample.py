#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Data Resample Strategy.

This module demonstrates data resampling functionality by converting
daily data to weekly timeframe using a dual moving average crossover strategy.
"""
