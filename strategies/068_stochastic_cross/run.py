#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Run script for Stochastic Cross Strategy.

This script runs a backtest of the Stochastic crossover strategy which
combines SMA trend indicators with Stochastic oscillator signals.
"""
...
from strategy_stochastic_cross import StochasticCrossStrategy
...
def run():
    """Run the Stochastic crossover strategy backtest.
