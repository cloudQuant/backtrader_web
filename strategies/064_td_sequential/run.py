#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Run script for TD Sequential Strategy.

This script runs the TD Sequential strategy which implements
Tom DeMark's TD Sequential indicator.
"""
...
def run():
    """Run the TD Sequential strategy backtest.
...
if __name__ == "__main__":
    ...
    from strategy_td_sequential import TDSequentialStrategy

    print("=" * 60)
    print("TD Sequential Strategy")
    print("=" * 60)
    run()
