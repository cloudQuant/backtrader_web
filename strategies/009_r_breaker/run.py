#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""R-Breaker Intraday Breakout Strategy Runner.
...
from strategy_r_breaker import RBreakerStrategy, RbPandasFeed
...
def load_rb889_data(filename: str = "RB889.csv", max_rows: int = 50000) -> pd.DataFrame:
    ...
    Maintains the original data loading logic and limits data rows for faster testing.
...
def run():
    """Run the R-Breaker intraday breakout strategy backtest.
