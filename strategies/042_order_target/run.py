...
# -*- coding: utf-8 -*-
"""
Run script for Order Target Strategy.

This script runs the Order Target Strategy backtest with data loading
...
from strategy_order_target import load_config, OrderTargetStrategy
...
def run():
    ...
    loads historical data, runs the backtest, and validates results.
    ...
    data_file = data_config.get('symbol', 'yhoo-1996-2014') + ".txt"
    ...
    assert abs(max_drawdown - 9.591524052078132) < 1e-6, f"Expected max_drawdown=9.591524052078132, got {max_drawdown}"
...
if __name__ == "__main__":
    print("=" * 60)
    print("Order Target Strategy Backtest")
    print("=" * 60)
    run()
