...
# -*- coding: utf-8 -*-
"""
Run script for MultiTrades Strategy.

This script runs the MultiTrades Strategy backtest with data loading
...
from strategy_multitrades import load_config, MultiTradesStrategy
...
def run():
    ...
    loads historical data, runs the backtest with multi-trade mode, and validates results.
    ...
    assert abs(annual_return - (0.009052737167560457)) < 1e-6, f"Expected annual_return=0.009052737167560457, got {annual_return}"
    assert abs(max_drawdown - 3.195383835382446) < 1e-6, f"Expected max_drawdown=3.195383835382446, got {max_drawdown}"
...
if __name__ == "__main__":
    print("=" * 60)
    print("MultiTrades Strategy Backtest")
    print("=" * 60)
    run()
