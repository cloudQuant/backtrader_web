"""Run script for Fei (Fei A'li Four-Price Improved Version) Futures Strategy.

This script runs the Fei A'li four-price improved version strategy using rebar
futures data RB889.csv. The strategy uses Bollinger Bands for filtering.
"""
...
# Import strategy and data feed from strategy_fei.py
from strategy_fei import FeiStrategy, RbPandasFeed
...
def run():
    """Run the Fei A'li four-price improved version strategy backtest.

    This function:
    1. Loads configuration from config.yaml
    2. Loads rebar futures data RB889.csv
    3. Creates and configures cerebro instance
    4. Runs the backtest
    ...
    cerebro.addstrategy(FeiStrategy,
...
if __name__ == "__main__":
    print("=" * 60)
    print("Fei (Fei A'li Four-Price Improved Version) Strategy")
    print("=" * 60)
    run()
