#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Run script for Donchian Channel Strategy.

This script runs the Donchian Channel strategy which implements
a classic trend-following breakout strategy.
"""
...
def load_data(symbol: str):
    ...
    Returns:
        Backtrader data feed with date range filter (2010-2014)
    """
...
def run():
    """Run the Donchian Channel strategy backtest.
...
if __name__ == "__main__":
    ...
    from strategy_donchian_channel import DonchianChannelStrategy

    print("=" * 60)
    print("Donchian Channel Strategy")
    print("=" * 60)
    run()
