#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Strategy Runner - Ultimate OscillatorIndicatorStrategy"""
...
from strategy_ultimate_oscillator import UltimateOscillatorStrategy
...
def run():
    ...
    cerebro.addstrategy(UltimateOscillatorStrategy, **params)
