#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Run script for RSI Dip Buy Strategy."""
...
from strategy_rsi_dip_buy import RSIDipBuyStrategy, load_config
...
def run():
    """Run the RSI Dip Buy strategy backtest.

    This function validates that the RSI-based dip buying strategy correctly
    ...
    assert abs(max_drawdown - 0.16146151315165563) < 1e-6, f"Expected max_drawdown=0.16146151315165563, got {max_drawdown}"
...
if __name__ == "__main__":
    print("=" * 60)
    print("RSI Dip Buy Strategy Backtest")
    print("=" * 60)
    run()
