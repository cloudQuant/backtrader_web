#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Au Boll Reverser strategy runner for simulated trading (CTP only).
...
from strategy_boll_reverser import BollReverserStrategy
...
def run_ctp_session(config: dict):
    ...
    try:
        ...
        cerebro.addstrategy(BollReverserStrategy, **params)
        cerebro.addobserver(
...
if __name__ == "__main__":
    print("=" * 60)
    print("Au Boll Reverser Strategy")
    print("=" * 60)
    run()
