#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""MT5 XAUUSD Range Breakout Strategy Runner.
...
from strategy_mt5_xauusd_breakout import Mt5XauusdBreakoutStrategy
...
def run():
    ...
    compression = tf_map.get(timeframe_str, 60)
    ...
    print("=" * 60)
    print("MT5 XAUUSD Breakout Strategy")
    print("=" * 60)
    ...
    try:
        ...
        cerebro.broker.setcommission(commission=sim_cfg.get("commission", 0.0001))
        cerebro.adddata(data, name=symbol)
        cerebro.addstrategy(Mt5XauusdBreakoutStrategy, **params)
        cerebro.addobserver(
