#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""MT5 AUDUSD RSI Pullback Entry Strategy Runner.
...
from strategy_mt5_audusd_rsi_pullback import Mt5AudusdRsiPullbackStrategy
...
def run():
    ...
    timeframe_str = data_cfg.get("timeframe", "15m")
    tf_map = {
    ...
    print("=" * 60)
    print("MT5 AUDUSD RSI Pullback Strategy")
    print("=" * 60)
    ...
    try:
        ...
        cerebro.addstrategy(Mt5AudusdRsiPullbackStrategy, **params)
        cerebro.addobserver(
