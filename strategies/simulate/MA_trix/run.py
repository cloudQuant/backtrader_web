#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""MA Trix strategy runner for simulated trading (CTP only).
...
from strategy_trix import TrixStrategy
...
def run_ctp_session(config: dict):
    ...
    try:
        ...
        cerebro.addstrategy(TrixStrategy, **params)
        cerebro.addobserver(
