#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Zn Kelter strategy runner for simulated trading (CTP only).
...
from strategy_kelter import KeltnerStrategy
...
def run_ctp_session(config: dict):
    ...
    try:
        ...
        cerebro.addstrategy(KeltnerStrategy, **params)
        cerebro.addobserver(
