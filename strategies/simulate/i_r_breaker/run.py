#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""I R Breaker strategy runner for simulated trading (CTP only).
...
from strategy_r_breaker import RBreakerStrategy
...
def run_ctp_session(config: dict):
    ...
    try:
        ...
        cerebro.addstrategy(RBreakerStrategy, **params)
        cerebro.addobserver(
