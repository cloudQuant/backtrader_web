#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""SR Keltner Channel strategy runner for simulated trading (CTP only).
...
from strategy_keltner_channel import KeltnerChannelStrategy
...
def run_ctp_session(config: dict):
    ...
    try:
        ...
        cerebro.addstrategy(KeltnerChannelStrategy, **params)
        cerebro.addobserver(
...
if __name__ == "__main__":
    print("=" * 60)
    print("SR Keltner Channel Strategy")
    print("=" * 60)
    run()
