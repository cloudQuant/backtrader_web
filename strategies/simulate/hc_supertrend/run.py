#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Hc Supertrend strategy runner for simulated trading (CTP only).
...
from strategy_supertrend import SuperTrendStrategy
...
def run_ctp_session(config: dict):
    ...
    try:
        ...
        cerebro.addstrategy(SuperTrendStrategy, **params)
        cerebro.addobserver(
