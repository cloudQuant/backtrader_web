#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""OI RSI Dip Buy strategy runner for simulated trading (CTP only).
...
from strategy_rsi_dip_buy import RSIDipBuyStrategy
...
def run_ctp_session(config: dict):
    ...
    try:
        ...
        cerebro.addstrategy(RSIDipBuyStrategy, **params)
        cerebro.addobserver(
