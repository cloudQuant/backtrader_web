#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""CF Donchian Channel strategy runner for simulated trading (CTP only).
...
def run_ctp_session(config: dict):
    ...
    try:
        ...
        cerebro.addstrategy(DonchianChannelStrategy, **params)
        cerebro.addobserver(
...
if __name__ == "__main__":
    print("=" * 60)
    print("CF Donchian Channel Strategy")
    print("=" * 60)
    run()
