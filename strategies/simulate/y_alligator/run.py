#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Y Alligator strategy runner for simulated trading (CTP only).
...
from strategy_alligator import AlligatorStrategy
...
def run_ctp_session(config: dict):
    ...
    try:
        ...
        cerebro.addstrategy(AlligatorStrategy, **params)
        cerebro.addobserver(
