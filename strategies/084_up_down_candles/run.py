#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Strategy Runner - Up/Down CandleMean ReversionStrategy"""
...
from strategy_up_down_candles import (
    UpDownCandlesStrategy,
...
def run():
    ...
    cerebro.addstrategy(UpDownCandlesStrategy, **params)
    ...
    assert abs(max_drawdown - 0.13256895983198377) < 1e-6, f"Expected max_drawdown=0.13256895983198377, got {max_drawdown}"
