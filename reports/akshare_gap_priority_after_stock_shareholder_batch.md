# AkShare Gap Priority After Stock Shareholder Batch

- Source audit: `reports/akshare_data_completeness_audit_after_stock_shareholder_batch.json`
- Remaining gaps: 265
- Has data: 782 / 1047
...
| 30 | 773 | `stock_gpzy_pledge_ratio_detail_em` | stocks/daily | missing_table | `STOCK_GPZY_PLEDGE_RATIO_DETAIL_EM` | COMPLETED | 核心资产类别 |
| 30 | 774 | `stock_gpzy_pledge_ratio_em` | stocks/daily | missing_table | `STOCK_GPZY_PLEDGE_RATIO_EM` | COMPLETED | 核心资产类别 |
| 30 | 775 | `stock_gpzy_profile_em` | stocks/daily | missing_table | `STOCK_GPZY_PROFILE_EM` | COMPLETED | 核心资产类别 |
| 30 | 776 | `stock_gsrl_gsdt_em` | stocks/daily | missing_table | `STOCK_GSRL_GSDT_EM` | COMPLETED | 核心资产类别 |
| 30 | 783 | `stock_hk_fhpx_detail_ths` | stocks/daily | missing_table | `STOCK_HK_FHPX_DETAIL_THS` | COMPLETED | 核心资产类别 |
