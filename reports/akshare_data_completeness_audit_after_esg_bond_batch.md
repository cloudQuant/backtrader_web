...
- Generated: 2026-06-22T10:44:21.976351+00:00
- TODO tasks: 1047 ({'done': 1041, 'failed': 6})
- Physical tables: 927 total, 900 non-empty, 27 empty
- Task data status: {'has_data': 896, 'rows_after_zero_but_physical_data': 671, 'missing_table': 124, 'checked_without_data': 145, 'empty_table': 27}
- Rows-after-zero but physical data exists: 671
- Checked tasks without physical data: 145
...
| --- | ---: | ---: | ---: | ---: | ---: |
| bonds | 37 | 0 | 2 | 2 | 33 |
| common | 273 | 3 | 71 | 74 | 249 |
| funds | 113 | 7 | 5 | 12 | 82 |
| futures | 50 | 7 | 6 | 13 | 37 |
| indexs | 82 | 9 | 2 | 10 | 82 |
| stocks | 341 | 1 | 38 | 34 | 188 |
...
| 57 | `amac_member_sub_info` | common/weekly | missing_table | `AMAC_MEMBER_SUB_INFO` | `` |  | COMPLETED rows_after=0 |
| 60 | `amac_securities_info` | common/weekly | missing_table | `AMAC_SECURITIES_INFO` | `` |  | COMPLETED rows_after=0 |
