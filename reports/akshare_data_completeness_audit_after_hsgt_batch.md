...
- Generated: 2026-06-22T12:41:08.907279+00:00
- TODO tasks: 1047 ({'done': 1042, 'failed': 5})
- Physical tables: 955 total, 928 non-empty, 27 empty
- Task data status: {'has_data': 924, 'rows_after_zero_but_physical_data': 671, 'missing_table': 96, 'checked_without_data': 118, 'empty_table': 27}
- Rows-after-zero but physical data exists: 671
- Checked tasks without physical data: 118
...
| --- | ---: | ---: | ---: | ---: | ---: |
| bonds | 37 | 0 | 2 | 2 | 33 |
| common | 281 | 3 | 63 | 66 | 249 |
| funds | 115 | 7 | 3 | 10 | 82 |
| futures | 50 | 7 | 6 | 13 | 37 |
| indexs | 82 | 9 | 2 | 10 | 82 |
| stocks | 359 | 1 | 20 | 17 | 188 |
...
| 427 | `fund_lof_hist_em` | funds/daily | missing_table | `FUND_LOF_HIST_EM` | `` |  | COMPLETED rows_after=0 |
| 504 | `option_sse_minute_sina` | funds/hourly | missing_table | `OPTION_SSE_MINUTE_SINA` | `` |  | COMPLETED rows_after=0 |
...
| 392 | `financial_fund_hist_em` | funds/weekly | empty_table | `FINANCIAL_FUND_HIST_EM` | `FINANCIAL_FUND_HIST_EM` | 0 | COMPLETED rows_after=0 |
| 406 | `fund_dividend_rank_em` | funds/weekly | empty_table | `FUND_DIVIDEND_RANK_EM` | `FUND_DIVIDEND_RANK_EM` | 0 | COMPLETED rows_after=0 |
| 425 | `fund_lcx_rank_em` | funds/weekly | empty_table | `FUND_LCX_RANK_EM` | `FUND_LCX_RANK_EM` | 0 | COMPLETED rows_after=0 |
| 455 | `graded_fund_daily_em` | funds/weekly | empty_table | `GRADED_FUND_DAILY_EM` | `GRADED_FUND_DAILY_EM` | 0 | COMPLETED rows_after=0 |
| 457 | `hk_fund_dividend_em` | funds/weekly | empty_table | `HK_FUND_DIVIDEND_EM` | `HK_FUND_DIVIDEND_EM` | 0 | COMPLETED rows_after=0 |
| 488 | `option_hist_dce` | funds/weekly | missing_table | `OPTION_HIST_DCE` | `` |  | COMPLETED rows_after=0 |
| 510 | `reits_hist_em` | funds/weekly | empty_table | `REITS_HIST_EM` | `REITS_HIST_EM` | 0 | FAILED rows_after=None |
| 536 | `futures_hist_em` | futures/daily | missing_table | `FUTURES_HIST_EM` | `` |  | COMPLETED rows_after=0 |
| 552 | `futures_spot_sys` | futures/hourly | missing_table | `FUTURES_SPOT_SYS` | `` |  | COMPLETED rows_after=0 |
