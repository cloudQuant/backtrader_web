# AkShare Gap Priority After Options Stock Batch V2

- Source audit: `reports/akshare_data_completeness_audit_after_options_stock_batch_v2.json`
- Remaining gaps: 185
- Has data: 862 / 1047
...
| 5 | 106 | `get_receipt` | common/daily | missing_table | `GET_RECEIPT` | COMPLETED |  |
| 5 | 107 | `get_roll_yield` | common/daily | missing_table | `GET_ROLL_YIELD` | COMPLETED |  |
