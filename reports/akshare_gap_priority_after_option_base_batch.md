# AkShare Gap Priority After Option Base Batch

- Source audit: `reports/akshare_data_completeness_audit_after_option_base_batch.json`
- Remaining gaps: 316
- Has data: 731 / 1047
...
| 30 | 717 | `stock_comment_em` | stocks/daily | missing_table | `STOCK_COMMENT_EM` | COMPLETED | 核心资产类别 |
| 30 | 718 | `stock_concept_cons_futu` | stocks/daily | missing_table | `STOCK_CONCEPT_CONS_FUTU` | COMPLETED | 核心资产类别 |
| 30 | 721 | `stock_cyq_em` | stocks/daily | missing_table | `STOCK_CYQ_EM` | COMPLETED | 核心资产类别 |
| 30 | 723 | `stock_dxsyl_em` | stocks/daily | missing_table | `STOCK_DXSYL_EM` | COMPLETED | 核心资产类别 |
| 30 | 724 | `stock_dzjy_hygtj` | stocks/daily | missing_table | `STOCK_DZJY_HYGTJ` | COMPLETED | 核心资产类别 |
