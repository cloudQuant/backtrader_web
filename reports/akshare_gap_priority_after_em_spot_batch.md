# AkShare Gap Priority After EM Spot Batch

- Source audit: `reports/akshare_data_completeness_audit_after_em_spot_batch.json`
- Remaining gaps: 331
- Has data: 716 / 1047
...
| 30 | 474 | `option_comm_symbol` | funds/weekly | missing_table | `OPTION_COMM_SYMBOL` | COMPLETED | 核心资产类别 |
| 30 | 478 | `option_contract_info_ctp` | funds/weekly | missing_table | `OPTION_CONTRACT_INFO_CTP` | COMPLETED | 核心资产类别 |
| 30 | 499 | `option_sse_codes_sina` | funds/daily | missing_table | `OPTION_SSE_CODES_SINA` | COMPLETED | 核心资产类别 |
| 30 | 501 | `option_sse_expire_day_sina` | funds/daily | missing_table | `OPTION_SSE_EXPIRE_DAY_SINA` | COMPLETED | 核心资产类别 |
| 30 | 503 | `option_sse_list_sina` | funds/daily | missing_table | `OPTION_SSE_LIST_SINA` | COMPLETED | 核心资产类别 |
