# AkShare Gap Priority After LHB Hot Batch

- Source audit: `reports/akshare_data_completeness_audit_after_lhb_hot_batch.json`
- Remaining gaps: 340
- Has data: 707 / 1047
...
| 30 | 409 | `fund_etf_fund_info_em` | funds/daily | missing_table | `FUND_ETF_FUND_INFO_EM` | COMPLETED | 核心资产类别 |
| 30 | 465 | `option_cffex_hs300_list_sina` | funds/daily | missing_table | `OPTION_CFFEX_HS300_LIST_SINA` | COMPLETED | 核心资产类别 |
