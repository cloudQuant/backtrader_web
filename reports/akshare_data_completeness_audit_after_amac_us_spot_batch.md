...
- Generated: 2026-06-22T11:36:14.450725+00:00
- TODO tasks: 1047 ({'done': 1041, 'failed': 6})
- Physical tables: 943 total, 916 non-empty, 27 empty
- Task data status: {'has_data': 912, 'rows_after_zero_but_physical_data': 671, 'missing_table': 108, 'checked_without_data': 129, 'empty_table': 27}
- Rows-after-zero but physical data exists: 671
- Checked tasks without physical data: 129
...
| 481 | `option_current_em` | funds/daily | missing_table | `OPTION_CURRENT_EM` | `` |  | COMPLETED rows_after=0 |
| 495 | `option_minute_em` | funds/hourly | missing_table | `OPTION_MINUTE_EM` | `` |  | COMPLETED rows_after=0 |
