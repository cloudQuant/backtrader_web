...
- Generated: 2026-06-22T02:46:16.112126+00:00
- TODO tasks: 1047 ({'done': 1047})
- Physical tables: 696 total, 647 non-empty, 49 empty
- Task data status: {'missing_table': 355, 'checked_without_data': 404, 'has_data': 643, 'rows_after_zero_but_physical_data': 640, 'empty_table': 49}
- Rows-after-zero but physical data exists: 640
- Checked tasks without physical data: 404
...
| --- | ---: | ---: | ---: | ---: | ---: |
| bonds | 33 | 1 | 5 | 6 | 33 |
| common | 251 | 3 | 93 | 96 | 249 |
| funds | 80 | 22 | 23 | 45 | 79 |
| futures | 36 | 11 | 16 | 27 | 36 |
| indexs | 81 | 9 | 3 | 12 | 81 |
| stocks | 162 | 3 | 215 | 218 | 162 |

## First Missing Or Empty Tasks

| Task | Script | Category | Status | Target | Matched Table | Rows | Latest Execution |
| ---: | --- | --- | --- | --- | --- | ---: | --- |
| 1 | `bond_buy_back_hist_em` | bonds/daily | missing_table | `BOND_BUY_BACK_HIST_EM` | `` |  | COMPLETED rows_after=0 |
...
| 38 | `bond_zh_hs_spot` | bonds/hourly | missing_table | `BOND_ZH_HS_SPOT` | `` |  | COMPLETED rows_after=0 |
| 19 | `bond_info_cm` | bonds/weekly | empty_table | `BOND_INFO_CM` | `BOND_INFO_CM` | 0 | COMPLETED rows_after=0 |
| 21 | `bond_info_detail_cm` | bonds/weekly | missing_table | `BOND_INFO_DETAIL_CM` | `` |  | COMPLETED rows_after=0 |
...
| 65 | `bank_fjcf_table_detail` | common/daily | missing_table | `BANK_FJCF_TABLE_DETAIL` | `` |  | COMPLETED rows_after=0 |
...
| 220 | `macro_china_trade_balance` | common/daily | missing_table | `MACRO_CHINA_TRADE_BALANCE` | `` |  | COMPLETED rows_after=0 |
...
| 326 | `macro_usa_non_farm` | common/daily | missing_table | `MACRO_USA_NON_FARM` | `` |  | COMPLETED rows_after=0 |
| 328 | `macro_usa_personal_spending` | common/daily | missing_table | `MACRO_USA_PERSONAL_SPENDING` | `` |  | COMPLETED rows_after=0 |
| 337 | `macro_usa_trade_balance` | common/daily | missing_table | `MACRO_USA_TRADE_BALANCE` | `` |  | COMPLETED rows_after=0 |
| 338 | `macro_usa_unemployment_rate` | common/daily | missing_table | `MACRO_USA_UNEMPLOYMENT_RATE` | `` |  | COMPLETED rows_after=0 |
