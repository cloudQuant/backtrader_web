# AkShare Gap Priority After Stock Event Batch

- Source audit: `reports/akshare_data_completeness_audit_after_stock_event_batch.json`
- Remaining gaps: 277
- Has data: 770 / 1047
...
| 30 | 730 | `stock_ebs_lg` | stocks/daily | missing_table | `STOCK_EBS_LG` | COMPLETED | 核心资产类别 |
