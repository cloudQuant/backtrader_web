# AkShare Gap Priority After Common Macro Batch

- Source audit: `reports/akshare_data_completeness_audit_after_common_macro_batch.json`
- Remaining gaps: 204
- Has data: 843 / 1047
...
| 75 | 696 | `stock_board_industry_hist_min_em` | stocks/hourly | missing_table | `STOCK_BOARD_INDUSTRY_HIST_MIN_EM` | FAILED: Script stock_board_industry_hist_min_em returned no data and target table stock_board_industry_hist_min_em is empty | 核心资产类别, 行情历史/分钟/tick, 最新执行已暴露失败原因 |
...
| 65 | 819 | `stock_hot_up_em` | stocks/daily | missing_table | `STOCK_HOT_UP_EM` | FAILED: Script stock_hot_up_em returned no data and target table stock_hot_up_em is empty | 核心资产类别, 资金流/持仓/榜单, 最新执行已暴露失败原因 |
...
| 30 | 967 | `stock_sns_sseinfo` | stocks/weekly | missing_table | `STOCK_SNS_SSEINFO` | COMPLETED | 核心资产类别 |
| 30 | 975 | `stock_sy_yq_em` | stocks/daily | missing_table | `STOCK_SY_YQ_EM` | COMPLETED | 核心资产类别 |
| 30 | 990 | `stock_xgsr_ths` | stocks/daily | missing_table | `STOCK_XGSR_THS` | COMPLETED | 核心资产类别 |
| 30 | 995 | `stock_yysj_em` | stocks/daily | missing_table | `STOCK_YYSJ_EM` | COMPLETED | 核心资产类别 |
| 30 | 1039 | `stock_zh_vote_baidu` | stocks/daily | missing_table | `STOCK_ZH_VOTE_BAIDU` | COMPLETED | 核心资产类别 |
...
| 20 | 372 | `spot_hog_three_way_soozhu` | common/hourly | missing_table | `SPOT_HOG_THREE_WAY_SOOZHU` | COMPLETED | 实时/池类数据 |
| 20 | 373 | `spot_hog_year_trend_soozhu` | common/hourly | missing_table | `SPOT_HOG_YEAR_TREND_SOOZHU` | COMPLETED | 实时/池类数据 |
| 20 | 374 | `spot_mixed_feed_soozhu` | common/hourly | missing_table | `SPOT_MIXED_FEED_SOOZHU` | COMPLETED | 实时/池类数据 |
...
| 5 | 44 | `air_quality_watch_point` | common/daily | missing_table | `AIR_QUALITY_WATCH_POINT` | COMPLETED |  |
| 5 | 46 | `akshare_catalog_endpoint` | common/daily | missing_table | `akshare_catalog_endpoint` | COMPLETED |  |
| 5 | 47 | `amac_aoin_info` | common/weekly | missing_table | `AMAC_AOIN_INFO` | COMPLETED |  |
| 5 | 48 | `amac_fund_abs` | common/daily | missing_table | `AMAC_FUND_ABS` | COMPLETED |  |
| 5 | 49 | `amac_fund_account_info` | common/weekly | missing_table | `AMAC_FUND_ACCOUNT_INFO` | COMPLETED |  |
| 5 | 50 | `amac_fund_info` | common/weekly | missing_table | `AMAC_FUND_INFO` | COMPLETED |  |
| 5 | 51 | `amac_fund_sub_info` | common/weekly | missing_table | `AMAC_FUND_SUB_INFO` | COMPLETED |  |
| 5 | 52 | `amac_futures_info` | common/weekly | missing_table | `AMAC_FUTURES_INFO` | COMPLETED |  |
| 5 | 53 | `amac_manager_cancelled_info` | common/weekly | missing_table | `AMAC_MANAGER_CANCELLED_INFO` | COMPLETED |  |
| 5 | 54 | `amac_manager_classify_info` | common/weekly | missing_table | `AMAC_MANAGER_CLASSIFY_INFO` | COMPLETED |  |
| 5 | 55 | `amac_manager_info` | common/weekly | missing_table | `AMAC_MANAGER_INFO` | COMPLETED |  |
| 5 | 56 | `amac_member_info` | common/weekly | missing_table | `AMAC_MEMBER_INFO` | COMPLETED |  |
| 5 | 57 | `amac_member_sub_info` | common/weekly | missing_table | `AMAC_MEMBER_SUB_INFO` | COMPLETED |  |
| 5 | 60 | `amac_securities_info` | common/weekly | missing_table | `AMAC_SECURITIES_INFO` | COMPLETED |  |
| 5 | 63 | `article_oman_rv` | common/daily | missing_table | `ARTICLE_OMAN_RV` | COMPLETED |  |
| 5 | 64 | `article_rlab_rv` | common/daily | missing_table | `ARTICLE_RLAB_RV` | COMPLETED |  |
