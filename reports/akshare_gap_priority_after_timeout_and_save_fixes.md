# AkShare Gap Priority After Timeout And Save Fixes

- Source audit: `reports/akshare_data_completeness_audit_after_timeout_and_save_fixes.json`
- Remaining gaps: 367
- Has data: 680 / 1047
...
| 90 | 823 | `stock_hsgt_hist_em` | stocks/daily | missing_table | `STOCK_HSGT_HIST_EM` | COMPLETED | 核心资产类别, 行情历史/分钟/tick, 资金流/持仓/榜单 |
| 90 | 953 | `stock_sector_fund_flow_hist` | stocks/weekly | missing_table | `STOCK_SECTOR_FUND_FLOW_HIST` | COMPLETED | 核心资产类别, 行情历史/分钟/tick, 资金流/持仓/榜单 |
...
| 70 | 445 | `fund_report_industry_allocation_cninfo` | funds/weekly | missing_table | `FUND_REPORT_INDUSTRY_ALLOCATION_CNINFO` | COMPLETED | 核心资产类别, 财务/公告/报表 |
| 70 | 446 | `fund_report_stock_cninfo` | funds/weekly | missing_table | `FUND_REPORT_STOCK_CNINFO` | COMPLETED | 核心资产类别, 财务/公告/报表 |
| 70 | 455 | `graded_fund_daily_em` | funds/weekly | empty_table | `GRADED_FUND_DAILY_EM` | COMPLETED | 核心资产类别, 行情历史/分钟/tick, 已有空表，可能只需修保存/参数 |
| 70 | 456 | `graded_fund_hist_em` | funds/weekly | empty_table | `GRADED_FUND_HIST_EM` | COMPLETED | 核心资产类别, 行情历史/分钟/tick, 已有空表，可能只需修保存/参数 |
| 70 | 460 | `money_fund_hist_em` | funds/weekly | empty_table | `MONEY_FUND_HIST_EM` | COMPLETED | 核心资产类别, 行情历史/分钟/tick, 已有空表，可能只需修保存/参数 |
...
| 70 | 703 | `stock_cash_flow_sheet_by_quarterly_em` | stocks/daily | missing_table | `STOCK_CASH_FLOW_SHEET_BY_QUARTERLY_EM` | COMPLETED | 核心资产类别, 财务/公告/报表 |
| 70 | 741 | `stock_financial_analysis_indicator` | stocks/daily | missing_table | `STOCK_FINANCIAL_ANALYSIS_INDICATOR` | COMPLETED | 核心资产类别, 财务/公告/报表 |
| 70 | 794 | `stock_hk_indicator_eniu` | stocks/daily | missing_table | `STOCK_HK_INDICATOR_ENIU` | COMPLETED | 核心资产类别, 财务/公告/报表 |
| 70 | 912 | `stock_notice_report` | stocks/daily | missing_table | `STOCK_NOTICE_REPORT` | COMPLETED | 核心资产类别, 财务/公告/报表 |
| 70 | 916 | `stock_profit_forecast_em` | stocks/daily | missing_table | `STOCK_PROFIT_FORECAST_EM` | COMPLETED | 核心资产类别, 财务/公告/报表 |
| 70 | 917 | `stock_profit_forecast_ths` | stocks/daily | missing_table | `STOCK_PROFIT_FORECAST_THS` | COMPLETED | 核心资产类别, 财务/公告/报表 |
| 70 | 918 | `stock_profit_sheet_by_quarterly_em` | stocks/daily | missing_table | `STOCK_PROFIT_SHEET_BY_QUARTERLY_EM` | COMPLETED | 核心资产类别, 财务/公告/报表 |
| 70 | 921 | `stock_profit_sheet_by_yearly_em` | stocks/daily | missing_table | `STOCK_PROFIT_SHEET_BY_YEARLY_EM` | COMPLETED | 核心资产类别, 财务/公告/报表 |
| 70 | 946 | `stock_research_report_em` | stocks/daily | missing_table | `STOCK_RESEARCH_REPORT_EM` | COMPLETED | 核心资产类别, 财务/公告/报表 |
| 70 | 997 | `stock_zcfz_bj_em` | stocks/daily | missing_table | `STOCK_ZCFZ_BJ_EM` | COMPLETED | 核心资产类别, 财务/公告/报表 |
| 70 | 1034 | `stock_zh_kcb_report_em` | stocks/daily | missing_table | `STOCK_ZH_KCB_REPORT_EM` | COMPLETED | 核心资产类别, 财务/公告/报表 |
...
| 65 | 491 | `option_hist_yearly_czce` | funds/weekly | missing_table | `OPTION_HIST_YEARLY_CZCE` | COMPLETED | 核心资产类别, 行情历史/分钟/tick |
...
| 65 | 537 | `futures_hist_table_em` | futures/daily | missing_table | `FUTURES_HIST_TABLE_EM` | COMPLETED | 核心资产类别, 行情历史/分钟/tick |
...
| 55 | 759 | `stock_gdfx_free_holding_detail_em` | stocks/daily | missing_table | `STOCK_GDFX_FREE_HOLDING_DETAIL_EM` | COMPLETED | 核心资产类别, 资金流/持仓/榜单 |
...
| 55 | 763 | `stock_gdfx_holding_analyse_em` | stocks/daily | missing_table | `STOCK_GDFX_HOLDING_ANALYSE_EM` | COMPLETED | 核心资产类别, 资金流/持仓/榜单 |
| 55 | 764 | `stock_gdfx_holding_change_em` | stocks/daily | missing_table | `STOCK_GDFX_HOLDING_CHANGE_EM` | COMPLETED | 核心资产类别, 资金流/持仓/榜单 |
| 55 | 765 | `stock_gdfx_holding_detail_em` | stocks/daily | missing_table | `STOCK_GDFX_HOLDING_DETAIL_EM` | COMPLETED | 核心资产类别, 资金流/持仓/榜单 |
...
| 55 | 767 | `stock_gdfx_holding_teamwork_em` | stocks/daily | missing_table | `STOCK_GDFX_HOLDING_TEAMWORK_EM` | COMPLETED | 核心资产类别, 资金流/持仓/榜单 |
| 55 | 792 | `stock_hk_hot_rank_em` | stocks/daily | missing_table | `STOCK_HK_HOT_RANK_EM` | COMPLETED | 核心资产类别, 资金流/持仓/榜单 |
| 55 | 803 | `stock_hold_change_cninfo` | stocks/weekly | missing_table | `STOCK_HOLD_CHANGE_CNINFO` | COMPLETED | 核心资产类别, 资金流/持仓/榜单 |
| 55 | 804 | `stock_hold_control_cninfo` | stocks/weekly | missing_table | `STOCK_HOLD_CONTROL_CNINFO` | COMPLETED | 核心资产类别, 资金流/持仓/榜单 |
| 55 | 805 | `stock_hold_management_detail_cninfo` | stocks/weekly | missing_table | `STOCK_HOLD_MANAGEMENT_DETAIL_CNINFO` | COMPLETED | 核心资产类别, 资金流/持仓/榜单 |
| 55 | 808 | `stock_hold_num_cninfo` | stocks/weekly | missing_table | `STOCK_HOLD_NUM_CNINFO` | COMPLETED | 核心资产类别, 资金流/持仓/榜单 |
| 55 | 809 | `stock_hot_deal_xq` | stocks/daily | missing_table | `STOCK_HOT_DEAL_XQ` | COMPLETED | 核心资产类别, 资金流/持仓/榜单 |
...
| 55 | 859 | `stock_institute_hold_detail` | stocks/daily | missing_table | `STOCK_INSTITUTE_HOLD_DETAIL` | COMPLETED | 核心资产类别, 资金流/持仓/榜单 |
| 55 | 878 | `stock_lhb_detail_em` | stocks/daily | missing_table | `STOCK_LHB_DETAIL_EM` | COMPLETED | 核心资产类别, 资金流/持仓/榜单 |
| 55 | 879 | `stock_lhb_ggtj_sina` | stocks/daily | missing_table | `STOCK_LHB_GGTJ_SINA` | COMPLETED | 核心资产类别, 资金流/持仓/榜单 |
...
| 55 | 896 | `stock_margin_account_info` | stocks/weekly | missing_table | `STOCK_MARGIN_ACCOUNT_INFO` | COMPLETED | 核心资产类别, 资金流/持仓/榜单 |
| 55 | 899 | `stock_margin_ratio_pa` | stocks/daily | missing_table | `STOCK_MARGIN_RATIO_PA` | COMPLETED | 核心资产类别, 资金流/持仓/榜单 |
...
| 55 | 963 | `stock_share_hold_change_bse` | stocks/daily | missing_table | `STOCK_SHARE_HOLD_CHANGE_BSE` | COMPLETED | 核心资产类别, 资金流/持仓/榜单 |
| 55 | 964 | `stock_share_hold_change_sse` | stocks/daily | missing_table | `STOCK_SHARE_HOLD_CHANGE_SSE` | COMPLETED | 核心资产类别, 资金流/持仓/榜单 |
| 55 | 965 | `stock_share_hold_change_szse` | stocks/daily | missing_table | `STOCK_SHARE_HOLD_CHANGE_SZSE` | COMPLETED | 核心资产类别, 资金流/持仓/榜单 |
| 55 | 966 | `stock_shareholder_change_ths` | stocks/daily | missing_table | `STOCK_SHAREHOLDER_CHANGE_THS` | COMPLETED | 核心资产类别, 资金流/持仓/榜单 |
...
| 45 | 530 | `futures_foreign_commodity_realtime` | futures/hourly | missing_table | `FUTURES_FOREIGN_COMMODITY_REALTIME` | COMPLETED | 核心资产类别, 实时/池类数据 |
...
| 45 | 561 | `futures_zh_spot` | futures/hourly | missing_table | `FUTURES_ZH_SPOT` | COMPLETED | 核心资产类别, 实时/池类数据 |
| 45 | 684 | `stock_bj_a_spot_em` | stocks/hourly | missing_table | `STOCK_BJ_A_SPOT_EM` | COMPLETED | 核心资产类别, 实时/池类数据 |
| 45 | 693 | `stock_board_concept_spot_em` | stocks/hourly | missing_table | `STOCK_BOARD_CONCEPT_SPOT_EM` | COMPLETED | 核心资产类别, 实时/池类数据 |
| 45 | 720 | `stock_cy_a_spot_em` | stocks/hourly | missing_table | `STOCK_CY_A_SPOT_EM` | COMPLETED | 核心资产类别, 实时/池类数据 |
| 45 | 795 | `stock_hk_main_board_spot_em` | stocks/hourly | missing_table | `STOCK_HK_MAIN_BOARD_SPOT_EM` | COMPLETED | 核心资产类别, 实时/池类数据 |
| 45 | 799 | `stock_hk_spot` | stocks/hourly | missing_table | `STOCK_HK_SPOT` | COMPLETED | 核心资产类别, 实时/池类数据 |
| 45 | 800 | `stock_hk_spot_em` | stocks/hourly | missing_table | `STOCK_HK_SPOT_EM` | COMPLETED | 核心资产类别, 实时/池类数据 |
| 45 | 961 | `stock_sh_a_spot_em` | stocks/hourly | missing_table | `STOCK_SH_A_SPOT_EM` | COMPLETED | 核心资产类别, 实时/池类数据 |
| 45 | 976 | `stock_sz_a_spot_em` | stocks/hourly | missing_table | `STOCK_SZ_A_SPOT_EM` | COMPLETED | 核心资产类别, 实时/池类数据 |
| 45 | 987 | `stock_us_spot_em` | stocks/hourly | missing_table | `STOCK_US_SPOT_EM` | COMPLETED | 核心资产类别, 实时/池类数据 |
| 45 | 1014 | `stock_zh_a_spot` | stocks/hourly | missing_table | `STOCK_ZH_A_SPOT` | COMPLETED | 核心资产类别, 实时/池类数据 |
| 45 | 1015 | `stock_zh_a_spot_em` | stocks/hourly | missing_table | `STOCK_ZH_A_SPOT_EM` | COMPLETED | 核心资产类别, 实时/池类数据 |
