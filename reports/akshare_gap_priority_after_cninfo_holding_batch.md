# AkShare Gap Priority After CNInfo Holding Batch

- Source audit: `reports/akshare_data_completeness_audit_after_cninfo_holding_batch.json`
- Remaining gaps: 337
- Has data: 710 / 1047
...
| 30 | 468 | `option_cffex_sz50_list_sina` | funds/daily | missing_table | `OPTION_CFFEX_SZ50_LIST_SINA` | COMPLETED | 核心资产类别 |
| 30 | 471 | `option_cffex_zz1000_list_sina` | funds/daily | missing_table | `OPTION_CFFEX_ZZ1000_LIST_SINA` | COMPLETED | 核心资产类别 |
| 30 | 473 | `option_comm_info` | funds/weekly | missing_table | `OPTION_COMM_INFO` | COMPLETED | 核心资产类别 |
