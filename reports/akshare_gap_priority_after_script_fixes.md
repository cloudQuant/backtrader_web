# AkShare Gap Priority After Script Fixes

- Source audit: `reports/akshare_data_completeness_audit_after_script_fixes.json`
- Remaining gaps: 373
- Has data: 674 / 1047
...
| 60 | 765 | `stock_gdfx_holding_detail_em` | stocks/daily | missing_table | `STOCK_GDFX_HOLDING_DETAIL_EM` | COMPLETED | 行情历史/分钟/tick |
| 60 | 766 | `stock_gdfx_holding_statistics_em` | stocks/daily | missing_table | `STOCK_GDFX_HOLDING_STATISTICS_EM` | COMPLETED | 行情历史/分钟/tick |
