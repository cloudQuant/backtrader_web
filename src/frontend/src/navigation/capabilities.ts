...
export const capabilities: Capability[] = [
  ...
  {
    id: 'config.promptGovernance',
    domainId: 'config',
    path: '/config/ai/prompt-governance',
    labelKey: 'nav.promptGovernance',
    icon: 'Document',
    legacyPaths: ['/admin/prompt-templates', '/ai/prompt-governance', '/ai/prompt-templates'],
    requiresAdmin: true,
    status: 'admin',
  },
  {
    id: 'config.aiCost',
    domainId: 'config',
    path: '/config/ai/observability',
    labelKey: 'nav.aiCost',
    icon: 'Monitor',
    legacyPaths: ['/admin/ai-observability', '/ai/observability', '/ai/ai-observability'],
    requiresAdmin: true,
    status: 'admin',
  },
  {
