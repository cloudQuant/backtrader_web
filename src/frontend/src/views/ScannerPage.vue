  ...
  <div class="space-y-4">
    ...
    <el-card>
      <div class="flex gap-3 flex-wrap items-center mb-4">
        <el-input
          v-model="universeText"
          placeholder="RB2510,IF2510"
          class="max-w-sm"
        />
        <el-input
          v-model="condition"
          placeholder="indicator > 0.6 and news_sentiment > 0.5"
          class="max-w-xl"
        />
        <el-input-number
      ...
      >
        {{ t('scannerPage.taskInfo', { taskId, status: taskStatus }) }}
      </div>
