...
async function loadData() {
  ...
  try {
    const [detailRes, klineRes, returnsRes] = await Promise.all([
      request.get(`/live-trading/${instanceId.value}/detail`) as Promise<BacktestDetailResponse>,
      request.get(`/live-trading/${instanceId.value}/kline`) as Promise<KlineWithSignalsResponse>,
      request.get(`/live-trading/${instanceId.value}/monthly-returns`) as Promise<MonthlyReturnsResponse>,
    ])
