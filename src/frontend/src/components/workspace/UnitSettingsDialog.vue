<template>
  <el-dialog :model-value="modelValue" title="策略研究--策略单元设置" width="700px" @update:model-value="$emit('update:modelValue', $event)" @open="initForm">
    <el-form v-if="unit" ref="formRef" :model="form" label-width="130px" size="default">
      <el-divider content-position="left">保证金/利率</el-divider>
      <el-row :gutter="20">
        <el-col :span="12">
      ...
      <el-divider content-position="left">公式交易设定</el-divider>
      <el-form-item label="初始资金">
        <el-input-number v-model="form.initial_cash" :min="1000" :step="10000" style="width: 200px" />
      </el-form-item>

      <el-divider content-position="left">手续费</el-divider>
      <el-row :gutter="20">
        <el-col :span="8">
      ...
      <el-divider content-position="left">滑点</el-divider>
      <el-row :gutter="20">
        <el-col :span="8">
