...
class TestLogin:
    ...
    @pytest.mark.parametrize("scenario,password_modifier,expected_status", [
        ("wrong password", lambda p: "wrongpassword", HTTP.UNAUTHORIZED),
        ("empty password", lambda p: "", HTTP.UNAUTHORIZED),
    ])
    async def test_login_invalid_credentials(self, client: AsyncClient, scenario, password_modifier, expected_status):
...
class TestMe:
    ...
    @pytest.mark.parametrize("headers,expected_status,description", [
    ...
    async def test_get_me_authentication_required(self, client: AsyncClient, headers, expected_status, description):
...
class TestChangePassword:
    ...
    @pytest.mark.parametrize("old_password,new_password,expected_status,error_type", [
