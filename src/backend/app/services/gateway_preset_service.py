...
_CTP_FUTURES: dict[str, Any] = {
    ...
    "params": {
        "gateway": {
            "enabled": True, "provider": "ctp_gateway", "exchange_type": "CTP",
            "asset_type": "FUTURE", "account_id": "",
        }
    },
}
...
_IB_WEB_STOCK: dict[str, Any] = {
    ...
    "params": {
        "gateway": {
            "enabled": True, "provider": "gateway", "exchange_type": "IB_WEB",
            "asset_type": "STK", "account_id": "DU123456",
...
_IB_WEB_FUTURES: dict[str, Any] = {
    ...
    "params": {
        "gateway": {
            "enabled": True, "provider": "gateway", "exchange_type": "IB_WEB",
            "asset_type": "FUT", "account_id": "DU123456",
            "base_url": "https://localhost:5000", "verify_ssl": False,
        }
    },
}
...
_BINANCE_SWAP: dict[str, Any] = {
    ...
    "editable_fields": [
        {"key": "account_id", "label": "账户标识", "input_type": "string", "placeholder": "自定义账户标识"},
        {"key": "api_key", "label": "API Key", "input_type": "string", "placeholder": "Binance API Key"},
        {"key": "secret_key", "label": "Secret Key", "input_type": "string", "placeholder": "Binance Secret Key"},
    ],
    "params": {
        "gateway": {
            "enabled": True, "provider": "gateway", "exchange_type": "BINANCE",
            "asset_type": "SWAP", "account_id": "", "api_key": "", "secret_key": "",
        }
    },
}
...
_OKX_SWAP: dict[str, Any] = {
    ...
    "editable_fields": [
        {"key": "account_id", "label": "账户标识", "input_type": "string", "placeholder": "自定义账户标识"},
        {"key": "api_key", "label": "API Key", "input_type": "string", "placeholder": "OKX API Key"},
        {"key": "secret_key", "label": "Secret Key", "input_type": "string", "placeholder": "OKX Secret Key"},
        {"key": "passphrase", "label": "Passphrase", "input_type": "string", "placeholder": "OKX Passphrase"},
    ],
    "params": {
        "gateway": {
            "enabled": True, "provider": "gateway", "exchange_type": "OKX",
            "asset_type": "SWAP", "account_id": "", "api_key": "", "secret_key": "",
            "passphrase": "",
        }
    },
...
_MT5_FOREX: dict[str, Any] = {
    ...
    "editable_fields": [
        {"key": "account_id", "label": "账户标识", "input_type": "string", "placeholder": "自定义账户标识"},
        {"key": "login", "label": "MT5 账号", "input_type": "string", "placeholder": "MT5 登录账号（数字）"},
        {"key": "password", "label": "MT5 密码", "input_type": "string", "placeholder": "MT5 登录密码"},
        {"key": "ws_uri", "label": "WebSocket 地址", "input_type": "string", "placeholder": "默认 wss://web.metatrader.app/terminal"},
    ],
    "params": {
        "gateway": {
            "enabled": True, "provider": "mt5_gateway", "exchange_type": "MT5",
            "asset_type": "OTC", "account_id": "", "login": "", "password": "",
            "ws_uri": "", "symbol_suffix": "",
        }
    },
}

_ALL_PRESETS: list[dict[str, Any]] = [
    _CTP_FUTURES, _IB_WEB_STOCK, _IB_WEB_FUTURES,
    _BINANCE_SWAP, _OKX_SWAP, _MT5_FOREX,
]
