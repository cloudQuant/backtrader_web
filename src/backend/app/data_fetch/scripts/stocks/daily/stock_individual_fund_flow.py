...
class StockIndividualFundFlow(AkshareToMySql):
    """Stock Individual Fund Flow"""

    def __init__(self, db_config=DB_CONFIG, logger=None):
        super().__init__(db_config, logger)
        self.table_name = "STOCK_INDIVIDUAL_FUND_FLOW"
    ...
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Stock Individual Fund Flow'
    """
    ...
    def fetch_data(self, **kwargs):
        ...
        Args:
            **kwargs: Parameters to pass to ak.stock_individual_fund_flow
