"""
Stock Gdfx Holding Statistics Em

数据源: AkShare
函数: stock_gdfx_holding_statistics_em
频率: daily
"""
...
class StockGdfxHoldingStatisticsEm(AkshareToMySql):
    ...
    def __init__(self, db_config=DB_CONFIG, logger=None):
        ...
        self.table_name = "STOCK_GDFX_HOLDING_STATISTICS_EM"
        self.create_table_sql = """
    CREATE TABLE IF NOT EXISTS `STOCK_GDFX_HOLDING_STATISTICS_EM` (
    ...
    def fetch_data(self, **kwargs):
        ...
        Args:
            **kwargs: Parameters to pass to ak.stock_gdfx_holding_statistics_em
...
def main():
    ...
    script = StockGdfxHoldingStatisticsEm()
    script.run()
