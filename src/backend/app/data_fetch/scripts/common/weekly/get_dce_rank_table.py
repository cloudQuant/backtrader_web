...
class GetDceRankTable(AkshareToMySql):
    """Get Dce Rank Table"""

    def __init__(self, db_config=DB_CONFIG, logger=None):
        super().__init__(db_config, logger)
        self.table_name = "GET_DCE_RANK_TABLE"
        self.create_table_sql = """
    CREATE TABLE IF NOT EXISTS `GET_DCE_RANK_TABLE` (
    ...
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Get Dce Rank Table'
    """
    ...
    def fetch_data(self, **kwargs):
        ...
        Args:
            **kwargs: Parameters to pass to ak.get_dce_rank_table
        ...
        try:
            ...
            for date_str in date_list:
                ...
                result = self.fetch_ak_data("get_dce_rank_table", **call_kwargs)
