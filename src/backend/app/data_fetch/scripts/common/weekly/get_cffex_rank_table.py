...
class GetCffexRankTable(AkshareToMySql):
    ...
    def __init__(self, db_config=DB_CONFIG, logger=None):
        ...
        self.table_name = "GET_CFFEX_RANK_TABLE"
        self.create_table_sql = """
    CREATE TABLE IF NOT EXISTS `GET_CFFEX_RANK_TABLE` (
    ...
    def fetch_data(self, **kwargs):
        ...
        Args:
            **kwargs: Parameters to pass to ak.get_cffex_rank_table
