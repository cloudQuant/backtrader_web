...
class CurrencyTimeSeries(AkshareToMySql):
    ...
    def __init__(self, db_config=DB_CONFIG, logger=None):
        ...
        self.table_name = "CURRENCY_TIME_SERIES"
        self.create_table_sql = """
    CREATE TABLE IF NOT EXISTS `CURRENCY_TIME_SERIES` (
    ...
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Currency Time Series'
    """
    ...
    def fetch_data(self, **kwargs):
        ...
        Args:
            **kwargs: Parameters to pass to ak.currency_time_series
