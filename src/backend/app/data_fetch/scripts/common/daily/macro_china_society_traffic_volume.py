"""
Macro China Society Traffic Volume

数据源: AkShare
函数: macro_china_society_traffic_volume
频率: daily
"""
...
class MacroChinaSocietyTrafficVolume(AkshareToMySql):
    ...
    def __init__(self, db_config=DB_CONFIG, logger=None):
        ...
        self.table_name = "MACRO_CHINA_SOCIETY_TRAFFIC_VOLUME"
        self.create_table_sql = """
    CREATE TABLE IF NOT EXISTS `MACRO_CHINA_SOCIETY_TRAFFIC_VOLUME` (
    ...
    def fetch_data(self, **kwargs):
        ...
        Args:
            **kwargs: Parameters to pass to ak.macro_china_society_traffic_volume
...
def main():
    ...
    script = MacroChinaSocietyTrafficVolume()
    script.run()
