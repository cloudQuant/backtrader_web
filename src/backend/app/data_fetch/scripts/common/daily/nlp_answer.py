...
class NlpAnswer(AkshareToMySql):
    """Nlp Answer"""
    ...
    def __init__(self, db_config=DB_CONFIG, logger=None):
        ...
        self.table_name = "NLP_ANSWER"
        self.create_table_sql = """
    CREATE TABLE IF NOT EXISTS `NLP_ANSWER` (
    ...
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Nlp Answer'
    """
    ...
    def fetch_data(self, **kwargs):
        ...
        Args:
            **kwargs: Parameters to pass to ak.nlp_answer

        Returns:
            pd.DataFrame: Fetched data
        """
        try:
            source_symbol = str(kwargs.get("question", kwargs.get("symbol", "人工智能")))
            result = self.fetch_ak_data("nlp_answer", **kwargs)
