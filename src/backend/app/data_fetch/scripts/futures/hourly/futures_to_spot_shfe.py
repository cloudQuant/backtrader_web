...
class FuturesToSpotShfe(AkshareToMySql):
    ...
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Futures To Spot Shfe'
    """
    ...
    def fetch_data(self, **kwargs):
        ...
        Args:
            **kwargs: Parameters to pass to ak.futures_to_spot_shfe
        ...
        try:
            ...
            df = self.fetch_ak_data("futures_to_spot_shfe", **kwargs)
