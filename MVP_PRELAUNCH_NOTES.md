...
- 历史知识库迁移：确认旧数据来源为 ReqDocs 的 `document_management` MySQL/MongoDB；已按 10 篇文档一批迁移到当前 `backtrader_web` 知识库表，结果为 44 个知识库、30,148 篇文档、11 个对话、44 条消息，且 44 个知识库均可公开读取。
