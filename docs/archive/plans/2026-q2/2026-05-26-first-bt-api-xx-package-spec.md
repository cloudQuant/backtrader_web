...
- `ai-for-investor`
- `ai-for-investor` 的任何 service / API / model
...
- 不要依赖 `ai-for-investor` secrets 逻辑
...
## 14. 与 `ai-for-investor` 的关系

`ai-for-investor` 对 `bt_api_xx` 的角色必须保持克制：
